...
- [x] Collection paints are visually distinguished on both the Munsell and HSL wheels
- [x] The emphasis ring scales correctly with zoom (stays the same apparent screen size)
- [x] Collection paints render on top of non-collection paints so the ring is never obscured
